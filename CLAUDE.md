...
- **Consumed by:** `svrn-operator-platform` lesson viewer
...
## Non-obvious rules
- **Notion is the source of truth, not this repo.** If lesson copy is edited, re-render from Notion via the skill — don't edit HTML by hand.
